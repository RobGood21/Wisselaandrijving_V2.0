...
*********************************************************************
  ...
  EEPROM de mensen van ARDUINO

  Libraries moeten zijn geinstalleerd in de map libraries.
...
void setup()
{
  ...
  DCC.SetBasicAccessoryDecoderPacketHandler(BasicAccDecoderPacket_Handler, true); // hier wordt dus de functie BasicAccDecoderPacket_Handler doorgegeven aan de dccdecoder
  DCC.SetupDecoder( 0x00, 0x00, kDCC_INTERRUPT ); //dit zijn allen manufacturer ids en een interrupt instelliing.
  pinMode(2, INPUT_PULLUP); //Pin met Pullup weerstand voor de DCC puls,
...
void loop()
{
  ...
  //*********************************************************
  //DCC decoder LOOP gedeelte
  //**********************************************************
  DCC.loop(); // DCC functie, test in volgorde de ingestelde adressen, 1 per doorloop.
  ...
  //***************************************************************
  //Einde Loop deel van de DCC decoder
  //***************************************************************
